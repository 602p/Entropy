...
/*
 * BIG FAT WARNING:
 * THIS IS NOT MY CODE! THIS CAME FROM THE DangIt! SOURCE
 * 
 * THIS CODE IS BY IPPO!
 * I JUST NEEDED TO MODIFY THE PRIVACY ATTRIBUTES!!!
 * */
...
namespace coffeeman
{
	...
	/// </summary>
	public class PermissiveEngineManager
	{
		...
		/// </summary>
		public PermissiveEngineManager(Part p)
		{
		...
		public EngineManager ToRestrictiveEngineManager()
		{
			return new EngineManager(this.p);
		}
